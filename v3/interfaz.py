...
class Interfaz(Frame):
    def __init__(self, container, **kwargs):
        ...
        self.dado.grid(row=2, column=2, padx=5, pady=5), self.dado.config(style='TEntry'), self.dado.insert(0, 2)
        ...
        self.dado_2.grid(row=2, column=3, padx=5, pady=5), self.dado_2.config(style='TEntry'), self.dado_2.insert(0, 0)
        ...
        self.dado_3.grid(row=2, column=4, padx=5, pady=5), self.dado_3.config(style='TEntry'), self.dado_3.insert(0, 0)
        ...
        self.dado_label.grid(row=2, column=1, sticky='E', padx=5, pady=5)
        ...
        # Botón tirar dados
        self.btn_roll = Button(self, text="Roll", command=tiradas.crear_roll(**kwargs, iface=self), style='R.TButton',
                               cursor='hand2')
        self.btn_roll.grid(row=0, column=0, padx=5, pady=5)

        # Botón tirar FATE
        self.btn_fate = Button(self, text=" FATE ", command=tiradas.crear_roll_fate(**kwargs, cuadro=self),
                               style='TButton',
                               cursor='hand2')
        self.btn_fate.grid(row=1, column=0, padx=5, pady=5)

        # Botón tirar RQ
        self.btn_rq = Button(self, text="RQ", command=tiradas.crear_roll_rq(**kwargs), style='HL2.TButton',
                             cursor='hand2')
        self.btn_rq.grid(row=4, column=2, padx=5, pady=5, columnspan=1)

        # Botón tirar Mythras
        self.btn_myth = Button(self, text="Mythras", command=tiradas.crear_roll_myth(**kwargs), style='HL1.TButton',
                               cursor='hand2')
        ...
        # Botón limpiar
        self.btn_clean = Button(self, text="Clear", command=tiradas.crear_limpiar(**kwargs), style='C.TButton',
                                cursor='hand2')
