...
class Genesys:
    ...
    def __init__(self, result, raiz, iface):
        ...
        # Etiqueta superior
        self.title = Label(iface, text="Genesys - Star Wars Custom Dice Pool", style='G.TLabel', justify='center')
