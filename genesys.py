...
class Genesys:
    ...
    def __init__(self,result,raiz,cuadro):
        ...
        self.btn_g = Button(cuadro,text="Genesys/SW",command=crear_roll_g(result,**grids),style='G.TButton',cursor='hand2')
